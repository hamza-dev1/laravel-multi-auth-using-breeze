                    ...
                    <form action="{{ route('admin.register') }}" method="post"
                        ...
                        <div class="w-full">
                            ...
                            <label class="block mt-4 text-sm">
                                ...
                                <input name="password"
                                    class="@error('password') border-1 border-red-600 dark:border-red-600 @else dark:border-gray-600 focus:border-purple-400 @enderror block w-full mt-1 text-sm  dark:bg-gray-700 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
