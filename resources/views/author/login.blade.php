                        ...
                        <div
                            ...
                            <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                                ...
                                @if (session()->has('error'))
                                    <div class="text-red-500 text-center mb-3 font-bold">
                                ...
                                <form method="post" action="{{ route('author.login') }}">
                                    ...
                                    <div class="relative w-full mb-3">
                                        <label class="block uppercase text-gray-700 text-xs font-bold mb-2"
                                            for="grid-password">Email</label><input name="email" type="email"
                                            class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                            placeholder="Email" style="transition: all 0.15s ease 0s;" />
                                    </div>
                                    <div class="relative w-full mb-3">
                                        <label class="block uppercase text-gray-700 text-xs font-bold mb-2"
                                            for="grid-password">Password</label><input name="password" type="password"
                                            class="border-0 px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
                                    ...
                                    <div class="text-gray-800 text-left mb-3 font-bold text-sm">
                                        ...
                                        <a href="{{ route('author.register-page') }}" class="text-blue-500">Sign up</a>
                                    </div>
                                </form>
                            </div>
                        </div>
